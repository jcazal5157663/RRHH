...
public class pais extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        nac.setFont(new java.awt.Font("Segoe UI", 0, 11)); // NOI18N
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(nac, javax.swing.GroupLayout.PREFERRED_SIZE, 202, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jLabel2.setText("Registro de Paises");
        ...
        btn_cerrar1.setBackground(new java.awt.Color(255, 255, 255));
        btn_cerrar1.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        btn_cerrar1.setForeground(new java.awt.Color(51, 51, 51));
        btn_cerrar1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/iconos/icons8_Close_Window_32px_1.png"))); // NOI18N
        btn_cerrar1.setText("Informe");
    ...
    private void btn_cerrar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_cerrar1ActionPerformed
        db.reporte("reporte/paises.jasper", null, "Paises", menu.getConexion());
    ...
    private void abm() {
        ...
        switch (operacion) {
            case 1:
                ...
                sql = "select * from pais where upper(descripcion) = '" + descripcion.getText().toUpperCase().replace("'", "''") + "'";

                res = db.QueryDinamico(sql, menu.getConexion());

                if (res == null) {
                    String columna[] = {"descripcion", "pronom_nacionalidad", "estado", "usuario_input"};
                    String datos[] = {"'" + descripcion.getText().replace("'", "''") + "'", "'" + nac.getText().replace("'", "''") + "'", String.valueOf(estado.getItemAt(estado.getSelectedIndex()).getId()), String.valueOf(menu.getIduser())};
                    String tbl = "pais";
                ...
                break;
            case 2:
                String columna2[] = {"descripcion", "pronom_nacionalidad", "estado", "usuario_update", "fecha_h_update"};
                String datos2[] = {"'" + descripcion.getText().replace("'", "''") + "'", "'" + nac.getText().replace("'", "''") + "'", String.valueOf(estado.getItemAt(estado.getSelectedIndex()).getId()), String.valueOf(menu.getIduser()), "now()"};
                String tbl2 = "pais";
    ...
    private void Selecciona() {
        ...
        if (row < 0) {
            ...
            id = Integer.parseInt(tabla.getValueAt(row, 0).toString());
            sql = "select descripcion,pronom_nacionalidad, estado from pais where id = " + id;
            res = db.QueryDinamico(sql, menu.getConexion());
