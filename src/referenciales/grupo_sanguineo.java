...
public class grupo_sanguineo extends javax.swing.JInternalFrame {
    ...
    private void CargarGrilla() {
        try {
            ...
            Logger.getLogger(grupo_sanguineo.class.getName()).log(Level.SEVERE, null, ex);
        }
        ...
        try {
            switch (operacion) {
                case 1:
                    ...
                    sql = "select * from grupo_sanguineo where trim(upper(descripcion)) = ?";
                    ...
                    if (res == null) {
                        ...
                        try {
                            sql = "INSERT INTO grupo_sanguineo(\n"
                ...
                case 2:
                    ...
                    break;
                case 3:
                    sql = "delete from grupo_sanguineo where id = ?";
    ...
    private void Selecciona() {
        ...
        if (row < 0) {
            ...
            try {
                id = Integer.parseInt(tabla.getValueAt(row, 0).toString());
                sql = "select descripcion, estado from grupo_sanguineo where id = ?";
                PreparedStatement ps = menu.getConexion().prepareStatement(sql);
                ps.setInt(1, id);
