...
public class tipo_cortesia extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Tipo de Cortesia");
    ...
    private void CargarGrilla() {
        try {
            ...
            Logger.getLogger(tipo_cortesia.class.getName()).log(Level.SEVERE, null, ex);
        }
        ...
        try {
            switch (operacion) {
                case 1:
                    ...
                    sql = "select * from cortesia where trim(upper(descripcion)) = ?";
                ...
                case 2:
                    ...
                    break;
                case 3:
                    sql = "delete from cortesia where id = ?";
    ...
    private void Selecciona() {
        ...
        if (row < 0) {
            ...
            try {
                id = Integer.parseInt(tabla.getValueAt(row, 0).toString());
                sql = "select descripcion, estado from cortesia where id = ?";
                PreparedStatement ps = menu.getConexion().prepareStatement(sql);
                ps.setInt(1, id);
