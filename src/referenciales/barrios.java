...
public class barrios extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        tabla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Barrio", "Ciudad", "País", "Estado", "Fecha H. Creación", "Fecha H. Modificación"
            }
        ) {
        ...
        jLabel2.setText("Registro de Barrios");
    ...
    private void CargarGrilla() {
        try {
            ...
            db.centrar(tabla, new int[]{0, 2, 3, 4, 5, 6});
        } catch (SQLException ex) {
            Logger.getLogger(barrios.class.getName()).log(Level.SEVERE, null, ex);
        }
