...
public class tipo_descuento extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Tipo de Descuentos");
        ...
        try {
            switch (operacion) {
                case 1:
                    ...
                    sql = "select * from tipo_descuentos where trim(upper(descripcion)) = ?";
                ...
                case 2:
                    ...
                    break;
                case 3:
                    sql = "delete from tipo_descuentos where id = ?";
