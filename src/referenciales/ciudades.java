...
public class ciudades extends javax.swing.JInternalFrame {
    ...
    public ciudades() {
        ...
        db.limitarCaracter(pais_descri, 50);
    ...
    private void initComponents() {
        ...
        tabla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Descripción", "País", "Estado", "Fecha H. Creación", "Fecha H. Modificación"
            }
        ) {
        ...
        jLabel2.setText("Registro de Ciudades");
        ...
        switch (operacion) {
            case 1:
                ...
                if (res == null) {                    
                    ...
                    String datos[] = {"'" + descripcion.getText().replace("'", "''") + "'", String.valueOf(idpais), String.valueOf(estado.getItemAt(estado.getSelectedIndex()).getId()), String.valueOf(menu.getIduser())};
                    String tbl = "ciudad";
            ...
            case 2:
                ...
                String datos2[] = {"'" + descripcion.getText().replace("'", "''") + "'", String.valueOf(idpais), String.valueOf(estado.getItemAt(estado.getSelectedIndex()).getId()), String.valueOf(menu.getIduser()), "now()"};
                String tbl2 = "ciudad";
    ...
    private void Selecciona() {
        ...
        if (row < 0) {
            ...
            idpais = Integer.parseInt(res[2]);
            pais_descri.setText(res[3]);
