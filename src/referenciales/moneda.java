...
public class moneda extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        tipoMon = new javax.swing.JComboBox<>();
        ...
        modal.setSize(new java.awt.Dimension(450, 215));
        ...
        jLabel4.setText("Abrev:");

        abrev.setFont(new java.awt.Font("Segoe UI", 0, 11)); // NOI18N
        abrev.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                abrevKeyTyped(evt);
            }
        });

        tipoMon.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Local", "Extranjera" }));
        tipoMon.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                tipoMonKeyTyped(evt);
            }
        });
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        ...
                        .addGap(16, 16, 16))
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        .addComponent(tipoMon, javax.swing.GroupLayout.PREFERRED_SIZE, 90, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel5Layout.setVerticalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(tipoMon, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jLabel2.setText("Registro de Monedas");
    ...
    private void abrevKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_abrevKeyTyped
        int letra = evt.getKeyChar();
        if (letra == 10) {
            tipoMon.requestFocus();
        }
    }//GEN-LAST:event_abrevKeyTyped

    private void tipoMonKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tipoMonKeyTyped
        int letra = evt.getKeyChar();
        if (letra == 10) {
            estado.requestFocus();
        }
    }//GEN-LAST:event_tipoMonKeyTyped
    ...
    private void abm() {
        ...
        switch (operacion) {
            case 1:
                ...
                sql = "select * from moneda where upper(descripcion) = '" + descripcion.getText().toUpperCase() + "'";

                res = db.QueryDinamico(sql, menu.getConexion());

                if (res == null) {
                    String columna[] = {"descripcion", "abrev", "tipo_moneda", "estado", "usuario_input"};
                    String datos[] = {"'" + descripcion.getText() + "'", "'" + abrev.getText() + "'", String.valueOf(tipoMon.getSelectedIndex()), String.valueOf(estado.getItemAt(estado.getSelectedIndex()).getId()), String.valueOf(menu.getIduser())};
                    String tbl = "moneda";
                ...
                break;
            case 2:
                String columna2[] = {"descripcion", "abrev", "tipo_moneda", "estado", "usuario_update", "fecha_h_update"};
                String datos2[] = {"'" + descripcion.getText() + "'", "'" + abrev.getText() + "'", String.valueOf(tipoMon.getSelectedIndex()), String.valueOf(estado.getItemAt(estado.getSelectedIndex()).getId()), String.valueOf(menu.getIduser()), "now()"};
                String tbl2 = "moneda";
    ...
    private Boolean validar() {
        ...
        if (abrev.getText().isEmpty()) {
            JOptionPane.showMessageDialog(modal, "Debe de Cargar una Abreviación");
            abrev.requestFocus();
            return false;
        }
        return true;
    ...
    private void Selecciona() {
        ...
        if (row < 0) {
            ...
            id = Integer.parseInt(tabla.getValueAt(row, 0).toString());
            sql = "select descripcion,abrev, tipo_moneda, estado from moneda where id = " + id;
            res = db.QueryDinamico(sql, menu.getConexion());

            descripcion.setText(res[1]);
            abrev.setText(res[2]);
            tipoMon.setSelectedIndex(Integer.parseInt(res[3]));
    ...
    private javax.swing.JComboBox<String> tipoMon;
