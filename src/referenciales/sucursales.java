...
public class sucursales extends javax.swing.JInternalFrame {
    ...
    public sucursales() {
        ...
        db.limitarCaracter(fax, 50);
        db.limitarCaracter(direccion, 250);
    ...
    private void initComponents() {
        ...
        modal.setSize(new java.awt.Dimension(450, 328));
        ...
        fax.setFont(new java.awt.Font("Segoe UI", 0, 11)); // NOI18N
        ...
        direccion.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Dirección", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 0, 11))); // NOI18N
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(fax, javax.swing.GroupLayout.PREFERRED_SIZE, 146, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        tabla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Descripción", "Teléfono", "Estado", "Fecha H. Creación", "Fecha H. Modificación"
            }
        ) {
        ...
        jLabel2.setText("Registro de Sucursales");
    ...
    private void CargarGrilla() {
        try {
            ...
            sql = "select dir.id, dir.descripcion,dir.telefono, \n"
                    + "case \n"
                    + "	dir.estado\n"
                    + "	when 1 then 'Activo'\n"
    ...
    private void abm() {
        ...
        switch (operacion) {
            case 1:
                ...
                sql = "select * from sucursal where upper(descripcion) = '" + descripcion.getText().toUpperCase() + "'";

                res = db.QueryDinamico(sql, menu.getConexion());

                if (res == null) {
                    String columna[] = {"descripcion", "empresa", "telefono", "direccion", "fax", "estado", "usuario_input"};
                    String datos[] = {"'" + descripcion.getText() + "'", "1", "'" + telefono.getText() + "'", "'" + direccion.getText() + "'", "'" + fax.getText() + "'", String.valueOf(estado.getItemAt(estado.getSelectedIndex()).getId()), String.valueOf(menu.getIduser())};
                    String tbl = "sucursal";
                ...
                break;
            case 2:
                String columna2[] = {"descripcion", "empresa", "telefono", "direccion", "fax", "estado", "usuario_update", "fecha_h_update"};
                String datos2[] = {"'" + descripcion.getText() + "'", "1", "'" + telefono.getText() + "'", "'" + direccion.getText() + "'", "'" + fax.getText() + "'", String.valueOf(estado.getItemAt(estado.getSelectedIndex()).getId()), String.valueOf(menu.getIduser()), "now()"};
                String tbl2 = "sucursal";
                String condicion = "id =" + id;
                db.Actualizar(tbl2, columna2, datos2, condicion, true, menu.getConexion());

                break;
            case 3:
                String tabla3 = "sucursal";
    ...
    private Boolean validar() {
        ...
        if (telefono.getText().isEmpty()) {
            JOptionPane.showMessageDialog(modal, "Debe de Cargar Telefono");
            telefono.requestFocus();
            return false;
        }

        if (direccion.getText().isEmpty()) {
            JOptionPane.showMessageDialog(modal, "Debe de Cargar una Dirección");
            direccion.requestFocus();
            return false;
        }
        return true;
    ...
    private void Selecciona() {
        ...
        if (row < 0) {
            ...
            id = Integer.parseInt(tabla.getValueAt(row, 0).toString());
            sql = "select descripcion,telefono, direccion,fax, estado from sucursal where id = " + id;
            res = db.QueryDinamico(sql, menu.getConexion());

            descripcion.setText(res[1]);
            telefono.setText(res[2]);
            direccion.setText(res[3]);
            fax.setText(res[4]);
            db.SelectIdCombo(estado, Integer.parseInt(res[5]));
            modal.setLocationRelativeTo(null);
            modal.setVisible(true);
        }
