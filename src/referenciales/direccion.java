...
public class direccion extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Registro de Direcciones");
    ...
    private void abm() {
        ...
        switch (operacion) {
            case 1:
                ...
                sql = "select * from direccion where descripcion = '" + descripcion.getText().toUpperCase() + "'";
    ...
    private void Selecciona() {
        ...
        if (row < 0) {
            ...
            id = Integer.parseInt(tabla.getValueAt(row, 0).toString());
            sql = "select descripcion, estado from direccion where id = " + id;
            res = db.QueryDinamico(sql, menu.getConexion());
