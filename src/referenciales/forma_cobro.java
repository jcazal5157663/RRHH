...
public class forma_cobro extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Forma de Cobro");
    ...
    private void abm() {
        ...
        switch (operacion) {
            case 1:
                ...
                sql = "select * from forma_cobro where descripcion = '" + descripcion.getText().toUpperCase() + "'";

                res = db.QueryDinamico(sql, menu.getConexion());

                if (res == null) {
                    String columna[] = {"descripcion", "estado", "usuario_input"};
                    String datos[] = {"'" + descripcion.getText().toUpperCase() + "'", String.valueOf(estado.getItemAt(estado.getSelectedIndex()).getId()), String.valueOf(menu.getIduser())};
                    String tbl = "forma_cobro";
                ...
                break;
            case 2:
                String columna2[] = {"descripcion", "estado", "usuario_update", "fecha_h_update"};
                String datos2[] = {"'" + descripcion.getText().toUpperCase() + "'", String.valueOf(estado.getItemAt(estado.getSelectedIndex()).getId()), String.valueOf(menu.getIduser()), "now()"};
                String tbl2 = "forma_cobro";
                String condicion = "id =" + id;
                db.Actualizar(tbl2, columna2, datos2, condicion, true, menu.getConexion());

                break;
            case 3:
                String tabla3 = "forma_cobro";
    ...
    private void Selecciona() {
        ...
        if (row < 0) {
            ...
            id = Integer.parseInt(tabla.getValueAt(row, 0).toString());
            sql = "select descripcion, estado from forma_cobro where id = " + id;
            res = db.QueryDinamico(sql, menu.getConexion());
