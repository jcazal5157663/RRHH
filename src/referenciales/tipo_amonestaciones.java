...
public class tipo_amonestaciones extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Tipo de Amonestaciones");
    ...
    private void CargarGrilla() {
        try {
            ...
            Logger.getLogger(tipo_amonestaciones.class.getName()).log(Level.SEVERE, null, ex);
        }
        ...
        try {
            switch (operacion) {
                case 1:
                    ...
                    sql = "select * from tipo_amonestaciones where trim(upper(descripcion)) = ?";
                    ...
                    if (res == null) {
                        ...
                        try {
                            sql = "INSERT INTO tipo_amonestaciones(\n"
                ...
                case 2:
                    ...
                    sql = "UPDATE tipo_amonestaciones\n"
                            + "	SET  \n"
                            + "	descripcion=?, \n"
                            + "	estado=?, \n"
                            + "	usuario_update=?,  \n"
                    ...
                    break;
                case 3:
                    sql = "delete from tipo_amonestaciones where id = ?";
    ...
    private void Selecciona() {
        ...
        if (row < 0) {
            ...
            try {
                id = Integer.parseInt(tabla.getValueAt(row, 0).toString());
                sql = "select descripcion, estado from tipo_amonestaciones where id = ?";
                PreparedStatement ps = menu.getConexion().prepareStatement(sql);
                ps.setInt(1, id);
