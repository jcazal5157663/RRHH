...
public class tipo_contrato extends javax.swing.JInternalFrame {
    ...
    private void CargarGrilla() {
        try {
            ...
            Logger.getLogger(tipo_contrato.class.getName()).log(Level.SEVERE, null, ex);
        }
        ...
        try {
            switch (operacion) {
                case 1:
                    ...
                    sql = "select * from tipo_de_contrato where trim(upper(descripcion)) = ?";
                    ...
                    if (res == null) {
                        ...
                        try {
                            sql = "INSERT INTO tipo_de_contrato(\n"
                ...
                case 2:
                    ...
                    break;
                case 3:
                    sql = "delete from tipo_de_contrato where id = ?";
    ...
    private void Selecciona() {
        ...
        if (row < 0) {
            ...
            try {
                id = Integer.parseInt(tabla.getValueAt(row, 0).toString());
                sql = "select descripcion, estado from tipo_de_contrato where id = ?";
                PreparedStatement ps = menu.getConexion().prepareStatement(sql);
                ps.setInt(1, id);
