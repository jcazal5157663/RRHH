...
public class tipo_documento extends javax.swing.JInternalFrame {
    ...
    private void abm() {
        ...
        switch (operacion) {
            case 1:
                ...
                sql = "select * from tipo_documento where descripcion = '" + descripcion.getText().toUpperCase() + "'";
    ...
    private void Selecciona() {
        ...
        if (row < 0) {
            ...
            id = Integer.parseInt(tabla.getValueAt(row, 0).toString());
            sql = "select descripcion, estado from tipo_documento where id = " + id;
            res = db.QueryDinamico(sql, menu.getConexion());
