...
public class buscador_departamento extends javax.swing.JDialog {
    ...
    public buscador_departamento(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Buscador Departamentos:::");
        setResizable(false);
    ...
    private void CargarGrilla() {
        try {
            ...
            Logger.getLogger(buscador_departamento.class.getName()).log(Level.SEVERE, null, ex);
        }
        ...
        try {
            switch (operacion) {
                case 1:
                    ...
                    sql = "select * from departamento where trim(upper(descripcion)) = ?";
    ...
    private void Selecciona() {
        ...
        if (row < 0) {
            ...
            try {
                id = Integer.parseInt(tabla.getValueAt(row, 0).toString());
                sql = "select descripcion, estado from departamento where id = ?";
                PreparedStatement ps = menu.getConexion().prepareStatement(sql);
                ps.setInt(1, id);
