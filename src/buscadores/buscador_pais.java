...
public class buscador_pais extends javax.swing.JDialog {
    ...
    public buscador_pais(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void tablaMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaMousePressed
        ...
        if (evt.getClickCount() == 2 && tabla.getSelectedRow() != -1) {
            ...
            Nacionalidad = tabla.getValueAt(row, 2).toString();
            this.dispose();
        }
    ...
    private void CargarGrilla() {
        ...
        sql = "select dir.id, dir.descripcion, dir.pronom_nacionalidad \n"
                + "from pais dir\n"
                + "order by dir.id";
        ...
        switch (operacion) {
            case 1:
                ...
                if (res == null) {
                    ...
                    String datos[] = {"'" + descripcion.getText() + "'", "'" + nac.getText() + "'", String.valueOf(estado.getItemAt(estado.getSelectedIndex()).getId()), String.valueOf(menu.getIduser())};
                    String tbl = "pais";
            ...
            case 2:
                ...
                String datos2[] = {"'" + descripcion.getText() + "'", "'" + nac.getText() + "'", String.valueOf(estado.getItemAt(estado.getSelectedIndex()).getId()), String.valueOf(menu.getIduser()), "now()"};
                String tbl2 = "pais";
