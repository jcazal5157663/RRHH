...
public class buscador_instituto extends javax.swing.JDialog {
    ...
    public buscador_instituto(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void CargarGrilla() {
        try {
            ...
            Logger.getLogger(buscador_instituto.class.getName()).log(Level.SEVERE, null, ex);
        }
