...
public class buscador_menu extends javax.swing.JDialog {
    ...
    public buscador_menu(java.awt.Dialog parent, boolean modal, Model_permisos permisos) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Buscador De Direcciones:::");
        setResizable(false);
    ...
    private void CargarGrilla() {
        try {
            ...
            Logger.getLogger(buscador_menu.class.getName()).log(Level.SEVERE, null, ex);
        }
        ...
        try {
            switch (operacion) {
                case 1:
                    ...
                    sql = "select * from menu_cab where trim(upper(descripcion)) = ?";
                ...
                case 2:
                    ...
                    break;
                case 3:
                    sql = "delete from menu_cab where id = ?";
    ...
    private void Selecciona() {
        ...
        if (row < 0) {
            ...
            try {
                id = Integer.parseInt(tabla.getValueAt(row, 0).toString());
                sql = "select descripcion, estado from menu_cab where id = ?";
                PreparedStatement ps = menu.getConexion().prepareStatement(sql);
                ps.setInt(1, id);
