...
public class roles_usuario extends javax.swing.JInternalFrame {
    ...
    public roles_usuario(Model_permisos permisos) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Roles de Usuario");
    ...
    private void CargarGrilla() {
        try {
            ...
            Logger.getLogger(roles_usuario.class.getName()).log(Level.SEVERE, null, ex);
        }
...
//        btn_informes.setVisible(permisos.getInforme());
    }
