...
public class menuCab extends javax.swing.JInternalFrame {
    ...
    public menuCab(Model_permisos permiso) {
        initComponents();

        this.permiso = permiso;
        //Corroboramos los permisos
        HabPermiso();
    ...
    private void CargarGrilla() {
        try {
            ...
            Logger.getLogger(menuCab.class.getName()).log(Level.SEVERE, null, ex);
        }
